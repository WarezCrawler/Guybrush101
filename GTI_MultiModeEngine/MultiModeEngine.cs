...
namespace GTI
{
            ...
            set
            {
                ...
                try
                {
                    foreach (string item in _propRatiosArray)
                    {
                        ...
                        if (!Single.TryParse(item, out numvalue))
    ...
    public class GTI_MultiModeEngine : GTI_MultiMode<MultiModeEngine>
    {
        ...
        public List<MultiModeEngine> GetengineModeList { get { return modes; } }
