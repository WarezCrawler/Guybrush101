...
/*
This class is licenced under another licence than the rest of this plugin

                       GNU GENERAL PUBLIC LICENSE
                       Version 3, 29 June 2007

    as the original created by mic_e. All credit goes to him.

This mod only corrects code to make it run in KSP 1.1, and include it in this module.
*/
...
namespace GTI
{
    ...
    public class NavBallDockingAlignmentIndicator : MonoBehaviour
    {
            ...
            int layer)
        {
            ...
            o.transform.GetComponent<Renderer>().sharedMaterial = new Material(texture);
            o.transform.GetComponent<Renderer>().sharedMaterial.mainTextureScale = textureScale;
            o.transform.GetComponent<Renderer>().sharedMaterial.mainTextureOffset = textureOffset;
            o.transform.GetComponent<Renderer>().sharedMaterial.color = col;
